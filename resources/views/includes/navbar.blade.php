                        ...
                        <div class="header-menu">
                            <ul>
                                <li><a href="#">languages <span>English <i class="fa fa-angle-down"></i> </span></a>
                                    <ul>
                                        <li><a href="#"><img src="img/languages/1.jpg" alt=""> English </a></li>
                                        <li><a href="#"><img src="img/languages/2.jpg" alt=""> Arab </a></li>
                                    </ul>
                                </li>
                ...
                <div class="col-md-3">
                    ...
                    <div class="catagory-menu hidden-sm hidden-xs">
                        ...
                        <div class="catagory-list-menu">
                            <ul>
                                <li class="arrow"> <a href="#"> <img src="img/menu-icon/1.jpg" alt=""> fashion</a>
                                ...
                                <li class="arrow"> <a href="#"> <img src="img/menu-icon/4.jpg" alt="">Accessories</a>
